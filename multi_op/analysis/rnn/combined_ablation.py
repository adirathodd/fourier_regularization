"""RNN combined-ip-elbow ablation analysis entrypoint."""
...
def combined_ip_svd_ablation_analysis(
    ...
    return common_combined_ablation.combined_ip_svd_ablation_analysis(
        model_cfg,
        checkpoint,
        dataset,
        op_elbows,
...
def combined_ip_svd_ablation_accuracy_curve(
    ...
    return common_combined_ablation.combined_ip_svd_ablation_accuracy_curve(
        model_cfg,
        checkpoint,
        dataset,
        save_dir,
